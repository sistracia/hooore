...
import type { Command, MenuListProps } from "./slash-command.types";
    ...
    onKeyDown: ({ event }: { event: React.KeyboardEvent }) => {
      ...
      if (event.key === "ArrowUp") {
        ...
        if (newCommandIndex < 0) {
          ...
          const commandsLength = props.items[newGroupIndex]?.commands.length;
          newCommandIndex = commandsLength ? commandsLength - 1 : 0;
        }
        ...
        if (newGroupIndex < 0) {
          ...
          const commandsLength = props?.items?.[newGroupIndex]?.commands.length;
          if (commandsLength) {
            newCommandIndex = commandsLength - 1;
          }
        }
