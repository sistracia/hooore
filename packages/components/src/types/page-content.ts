...
import type { CallToAction1Props, CallToAction1Slug } from "./template-types/call-to-action-1"
import type { CallToAction2Props, CallToAction2Slug } from "./template-types/call-to-action-2"
import type { CallToAction3Props, CallToAction3Slug } from "./template-types/call-to-action-3"
import type { CallToAction4Props, CallToAction4Slug } from "./template-types/call-to-action-4"
import type { CallToAction5Props, CallToAction5Slug } from "./template-types/call-to-action-5"
import type { CallToAction6Props, CallToAction6Slug } from "./template-types/call-to-action-6"
import type { Collections1Props, Collections1Slug } from "./template-types/collections-1"
import type { Collections2Props, Collections2Slug } from "./template-types/collections-2"
import type { Collections3Props, Collections3Slug } from "./template-types/collections-3"
...
import type { FeaturesList1Props, FeaturesList1Slug } from "./template-types/features-list-1"
import type { FeaturesList2Props, FeaturesList2Slug } from "./template-types/features-list-2"
import type { FeaturesList3Props, FeaturesList3Slug } from "./template-types/features-list-3"
import type { FeaturesList4Props, FeaturesList4Slug } from "./template-types/features-list-4"
import type { FeaturesList5Props, FeaturesList5Slug } from "./template-types/features-list-5"
import type { FeaturesList6Props, FeaturesList6Slug } from "./template-types/features-list-6"
import type { FeaturesList7Props, FeaturesList7Slug } from "./template-types/features-list-7"
...
import type { HowItWorks1Props, HowItWorks1Slug } from "./template-types/how-it-works-1"
import type { LogoList1Props, LogoList1Slug } from "./template-types/logo-list-1"
import type { LogoList2Props, LogoList2Slug } from "./template-types/logo-list-2"
import type { LogoList3Props, LogoList3Slug } from "./template-types/logo-list-3"
import type { LogoList4Props, LogoList4Slug } from "./template-types/logo-list-4"
...
import type { Testimonials1Props, Testimonials1Slug } from "./template-types/testimonials-1"
import type { Testimonials2Props, Testimonials2Slug } from "./template-types/testimonials-2"
import type { Testimonials3Props, Testimonials3Slug } from "./template-types/testimonials-3"
import type { Testimonials4Props, Testimonials4Slug } from "./template-types/testimonials-4"
