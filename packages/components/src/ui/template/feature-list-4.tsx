...
import type { FeaturesList4Props } from '../../types/template-types/features-list-4'
  ...
  return (
    <section className="pc-bg-white pc-py-6 sm:pc-py-8 lg:pc-py-12">
      <div className="pc-mx-auto pc-max-w-screen-2xl pc-px-4 md:pc-px-8">
        ...
        {features && (
          <div className="pc-grid pc-gap-12 sm:pc-grid-cols-2 xl:pc-grid-cols-3 xl:pc-gap-16">
            {features.map((feature, featureIndex) => {
              return (
                <div
                  key={featureIndex}
                  className="pc-flex pc-flex-col pc-items-center"
                >
                  {feature?.icon && (
                    <div className="pc-mb-6 pc-flex pc-h-12 pc-w-12 pc-items-center pc-justify-center pc-rounded-lg pc-bg-indigo-500 pc-text-white pc-shadow-lg md:pc-h-14 md:pc-w-14 md:pc-rounded-xl">
                      <Icon icon={feature.icon} className="h-6 w-6" />
                    </div>
                  )}
                  <h3 className="pc-mb-2 pc-text-center pc-text-lg pc-font-semibold md:pc-text-xl">
                    {feature?.headline}
                  </h3>
                  <p className="pc-mb-2 pc-text-center pc-text-gray-500">
                    {feature?.description}
                  </p>
