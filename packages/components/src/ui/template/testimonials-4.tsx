  ...
  return (
    <section className="pc-bg-white">
      <div className="pc-mx-auto pc-max-w-screen-xl pc-px-4 pc-py-12 sm:pc-px-6 lg:pc-px-8 lg:pc-py-16">
        ...
        <div className="pc-mt-8 pc-grid pc-grid-cols-1 pc-gap-4 md:pc-grid-cols-3 md:pc-gap-8">
          {testimonials?.map((testimonial, index) => {
            return (
              <blockquote
                key={index}
                className="pc-rounded-lg pc-bg-gray-50 pc-p-6 pc-shadow-sm sm:pc-p-8"
              >
