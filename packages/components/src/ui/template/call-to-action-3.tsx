  ...
  return (
    <section className="pc-bg-white pc-py-6 sm:pc-py-8 lg:pc-py-12">
      <div className="pc-mx-auto pc-max-w-screen-2xl pc-px-4 md:pc-px-8">
        <div className="pc-flex pc-flex-col pc-overflow-hidden pc-rounded-lg pc-bg-gray-200 sm:pc-flex-row md:pc-h-80">
          {background && (
            <div className="pc-order-first pc-h-48 pc-w-full pc-bg-gray-300 sm:pc-order-none sm:pc-h-auto sm:pc-w-1/2 lg:pc-w-2/5">
          ...
          <div className="pc-flex pc-w-full pc-flex-col pc-p-4 sm:pc-w-1/2 sm:pc-p-8 lg:pc-w-3/5">
            {headline && (
              <h2 className="pc-mb-4 pc-text-xl pc-font-bold pc-text-gray-800 md:pc-text-2xl lg:pc-text-4xl">
                {headline}
              </h2>
            )}

            {description && (
              <p className="pc-mb-8 pc-max-w-md pc-text-gray-600">
                {description}
              </p>
            )}
